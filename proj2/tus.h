...
#define TUS_MAXTHREADS 64 // maximum number of threads (including the main thread) that an application can have.
#define TUS_STACKSIZE  16384 // bytes, i.e., 32 KB. This is the stack size for a new thread.
